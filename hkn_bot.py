...
from utils.common import users, links
...
def inline_button(update: Update, context: CallbackContext) -> None:
    ...
    # TODO: Do something with the electronics groups
        ...
        inline_keyboard = [[InlineKeyboardButton("HKN Drive", url=links['hkn_drive'])],
                           [InlineKeyboardButton("HKN-Polito Discord Server", url=links['discord_server'])],
